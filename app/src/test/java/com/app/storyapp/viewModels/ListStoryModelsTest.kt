...
import com.app.storyapp.DataDummy
import com.app.storyapp.MainDispatcherRule
import com.app.storyapp.adapter.PagingStoryAdapter
import com.app.storyapp.data.StoryRepository
import com.app.storyapp.getOrAwaitValue
...
class ListStoryModelsTest {
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        val mainViewModel = ListStoryModels(repo)
